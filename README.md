...
Este repositório vai acumular informação sensível — impressão sobre pessoas, decisões internas, coisas que Juliana quer que o Claude *saiba* pra ter contexto, mas nunca *repita* fora de lugar (numa citação, num resumo exportado, num relatório pra terceiros).
