...
**Padrão:** Amazing PRO Personal Memory v1.0 | **Última atualização:** 07 de julho de 2026

---

## O que é este repositório

Este não é um repositório de código nem de skills compartilhadas — é o **cérebro pessoal** de Juliana dentro do Claude. Serve para três coisas:

1. **Memória de trabalho** — quem são as pessoas, projetos e termos que Juliana usa no dia a dia, para o Claude entender o contexto sem precisar reexplicar tudo a cada conversa.
2. **Melhores práticas** — processos, aprendizados e formas de trabalhar que Juliana quer que o Claude siga de forma consistente.
...
| | `amazing-skills` | `repositorio-juliana` |
|---|---|---|
| **O que guarda** | Metodologia oficial, skills, agentes, frameworks | Contexto pessoal, memória, práticas individuais |
| **Quem edita** | Time de metodologia / Thiago | Juliana |
| **Escopo** | Toda a empresa | Só o trabalho de Juliana |
...
├── melhores-praticas/         ← processos e aprendizados que Juliana quer preservar
...
│   ├── pessoas/                (perfil de cada pessoa relevante)
│   ├── projetos/                (perfil de cada projeto ativo ou relevante)
│   └── contexto/
...
**1. Clone o repositório** e abra o Claude (Code, Desktop ou Cowork) dentro dessa pasta. O `CLAUDE.md` é carregado automaticamente no início de cada sessão — é ele que dá ao Claude o contexto de quem é Juliana, com quem trabalha e em quê.
...
**3. Quando precisar de contexto profundo** (perfil completo de uma pessoa, histórico de um projeto), o Claude consulta `memory/` — não precisa estar tudo em `CLAUDE.md`.
...
Se é um framework/processo que a Amazing PRO usa oficialmente (ex: ROMA, Destilador) → pertence a `amazing-skills`, não aqui. Se é "como Juliana gosta de trabalhar" ou "quem é quem no time de Juliana" → aqui.
...
Não. Este repositório é de Juliana. A única regra é manter a estrutura — para que outros repositórios do time sigam o mesmo padrão e possam ser auditados/consolidados no futuro.
